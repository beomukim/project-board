...
import com.example.projectboard.domain.repository.querydsl.ArticleRepositoryCustom;
...
public interface ArticleRepository extends
    ...
    default void customize(QuerydslBindings bindings, QArticle root) {
        ...
        bindings.bind(root.hashtag).first(StringExpression::contains);
        bindings.bind(root.createdAt).first(DateTimeExpression::eq);
        bindings.bind(root.createdBy).first(StringExpression::contains);
    }
}